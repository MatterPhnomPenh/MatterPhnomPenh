    ...
    <>
      <header className="fixed inset-x-0 top-0 z-50 w-full">
              ...
              <div key={i} className="flex-shrink-0 flex items-center">
                {VALUES.map((item, idx) => (
                  <React.Fragment key={idx}>
                    <Link
                      href={item.href}
                      className="px-2 sm:px-2 lg:px-8 inline-block text-xs font-light tracking-wider text-black hover:opacity-70 transition sm:text-base md:text-lg lg:text-xl xl:text-2xl"
        ...
        <div className="px-4 sm:px-6 lg:px-12">
          <div
            className={`border-b border-black/20 transition-all duration-500 ${
        ...
        <div className="px-4 sm:px-6 lg:px-12">
          ...
          >
            ...
            >
              <Link
                href="/"
                className={`relative overflow-hidden font-bold tracking-tight text-black hover:opacity-80 transition-all duration-300 ${
                      ...
                      <button
                        ...
                        className={`flex items-center gap-1 text-sm font-bold uppercase tracking-widest transition-all ${
                          isInitiativesActive
                            ...
                            : "text-black/70 hover:text-black hover:opacity-100"
                        }`}
                      >
                      ...
                      <AnimatePresence>
                        {dropdownOpen && triggerRect && (
                          <motion.div
                            ...
                            onMouseLeave={handleDropdownLeave}
                          >
                            <div className="w-56 rounded-xl border border-black/20 bg-black/10 backdrop-blur-xl shadow-2xl py-3">
              ...
              >
                <motion.div whileHover="hover" whileTap={{ scale: 0.98 }}>
                  <button
                    ...
                    className="relative inline-flex items-center justify-center gap-4 border border-black rounded-md px-8 py-4 text-sm font-bold tracking-widest uppercase overflow-hidden whitespace-nowrap"
                  >
                    <motion.div
            ...
            {!mobileMenuOpen && (
              <motion.button
                ...
                className={`text-black lg:hidden relative w-8 h-8 flex items-center justify-center rounded-lg bg-black/10 hover:bg-black/20 transition-all duration-300 ${
          ...
          {mobileMenuOpen && (
            ...
            >
              ...
              <motion.div
                ...
                className="absolute top-4 left-4 right-4 bg-transparent backdrop-blur-xl rounded-2xl border border-black/20 shadow-2xl"
              >
                <div className="flex items-center justify-end p-4">
                  <button
                    onClick={() => setMobileMenuOpen(false)}
                    className="w-7 h-7 flex items-center justify-center rounded-lg bg-black/10 hover:bg-black/20 transition-all"
                  >
                          ...
                          <AnimatePresence>
                            {mobileDropdownOpen && (
                              <motion.div
                                ...
                                className="pl-3 space-y-1 border-l border-black/20 ml-3"
                              >
                                {EVENT_SUB_LINKS.map((link) => {
                ...
                <div className="p-3 border-t border-black/10">
                  <button
                    ...
                    className="relative inline-flex w-full items-center justify-center gap-2 border border-black rounded-lg px-4 py-2.5 text-xs font-bold tracking-widest uppercase overflow-hidden"
                  >
