...
//               <Link
//                 href="/"
//                 className="relative overflow-hidden text-2xl font-bold tracking-tight text-white hover:opacity-80 sm:text-3xl lg:text-5xl"
//               >
...
//             {/* Mobile Menu Toggle - HIDE when mobile menu is open */}
//             {!mobileMenuOpen && (
//               <motion.button
//                 initial={{ opacity: 0 }}
