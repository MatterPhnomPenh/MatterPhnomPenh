...
//         <div className="relative z-10 max-w-3xl text-white">
//             <h2 className="text-4xl md:text-5xl font-bold mb-4">Join Matter Camp</h2>
//             <p className="text-lg md:text-xl font-light mb-8">
//             Reconnect with nature and creativity in a weekend of campfires, ideas, and community under the stars.
//             </p>
//             <div className="flex flex-col md:flex-row items-center justify-center gap-4">
//             <button className="bg-white border border-white text-black px-6 py-3 text-lg rounded-full font-semibold hover:bg-transparent hover:text-white transition">
//                 Book Now
//             </button>
//             <button className="border border-white text-white px-6 py-3 text-lg rounded-full font-semibold flex items-center gap-2 hover:bg-white hover:text-black transition">
//                 <MapPin className="w-5 h-5" />
//                 View Camp Map
//             </button>
//             </div>
