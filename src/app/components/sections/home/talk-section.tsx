...
// //             <div className="w-full lg:w-1/2"> {/* Added right padding */}
// //               <a
// //                 href="https://youtu.be/"
// //                 target="_blank"
...
//   return (
//     <section id="talk" className="py-32 md:py-48 bg-black text-white overflow-hidden">
//       {/* Container with equal padding on both sides */}
...
//           className="text-center mb-16"
//         >
//           <h2 className="text-4xl sm:text-5xl lg:text-6xl xl:text-7xl font-bold tracking-tighter text-white mb-6 sm:mb-8">
//             Our Latest Talk
//           </h2>
//           <p className="text-base sm:text-lg md:text-xl font-light leading-relaxed tracking-wide text-white/90 max-w-3xl mx-auto px-4 sm:px-0">
//             Description about the talk, meaning conversations blah blah bla.
//           </p>
//         </motion.div>
...
//         {/* Middle Section - Video and Text Content with Equal Padding */}
//         <div className="flex justify-center">
//           <div className="w-full flex flex-col lg:flex-row items-center gap-8 sm:gap-12 lg:gap-16 xl:gap-20">
//             {/* Video - Left */}
...
//               transition={{ duration: 1, delay: 0.6, ease: "easeOut" }}
//               viewport={{ once: true }}
//               className="w-full lg:w-1/2 text-center lg:text-left space-y-6 sm:space-y-8 px-4 sm:px-6 lg:px-8 xl:px-10"
//             >
...
//               <div className="flex items-center gap-4 sm:gap-6 text-white/60 text-sm font-medium tracking-wide justify-center lg:justify-start flex-wrap">
//                 <span>15.11.2025</span>
//                 <span>•</span>
//                 <span>Matter Phnom Penh</span>
//               </div>
...
//             <Link
//               href="/talks"
//               className="relative inline-flex items-center justify-center gap-3 border-2 border-white rounded-md px-8 py-3.5 lg:px-10 lg:py-5 text-sm font-bold tracking-widest uppercase overflow-hidden group"
//             >
//               <motion.div
//                 className="absolute inset-0 bg-white"
//                 initial={{ x: "-100%" }}
...
export default function TalkSection() {
  return (
    <section id="talk" className="py-32 md:py-48 bg-black text-white overflow-hidden lg:px-24 px-8">
      {/* Container with equal padding on both sides */}
      <div className="">
        {/* Top Center - Title and Description */}
        <motion.div
        ...
        <div className="flex justify-center">
          <div className="w-full flex flex-col lg:flex-row items-center gap-16 ">
            ...
            >
              <div className="space-y-3 sm:space-y-4">
                <h3 className="text-xl lg:text-3xl font-bold tracking-tight text-white">
                  JIGSAW PUZZLE
                </h3>
                <p className="text-lg sm:text-xl text-white/80 font-light">
                  Pr. Sam Wujiale
