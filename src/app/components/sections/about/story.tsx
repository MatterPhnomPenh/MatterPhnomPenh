...
// // const Stories = ({}: any, ref: Ref<HTMLElement> | undefined) => {
...
// //     scrollYProgress, 
// //     [0, 0.1, 0.7, 1],
// //     ["100vh", "0vh", "0vh", "-150vh"]  // Deeper -150vh: Forces it way above screen, no chance of spillover
// //   );
...
// //   const itemVariants = {
// //     hidden: (custom: { initial: { rotate: any; x: any; y: any } }) => ({
// //       opacity: 0,
// //       rotate: custom.initial?.rotate || 0,
// //       x: custom.initial?.x || 0,
// //       y: custom.initial?.y || 0,
// //     }),
// //     visible: (custom: { target: { rotate: any; x: any; y: any }; duration: any; delay: any }) => ({
// //       opacity: 1,
